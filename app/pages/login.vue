      ...
      <div class="auth-card">
        ...
        <form @submit.prevent="login" class="auth-form">
          ...
          <button
            type="submit"
            class="auth-button"
            :disabled="loading.login || !isLoginFormValid"
          >
            <span v-if="loading.login">Signing in...</span>
...
const { loginForm, error, loading, loggedIn, isLoginFormValid } = storeToRefs(authStore)
